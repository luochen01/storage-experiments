...
drop dataverse twitter_validation_norepair_index_$v if exists;
create dataverse twitter_validation_norepair_index_$v if not exists;
use  twitter_validation_norepair_index_$v;
