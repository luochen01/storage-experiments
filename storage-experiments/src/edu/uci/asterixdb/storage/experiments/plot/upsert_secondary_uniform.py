...
upsert_antimatter_005 = open_csv(upsert_base_path + 'upsert-antimatter-UNIFORM-0.05.log')
upsert_antimatter_01 = open_csv(upsert_base_path + 'upsert-antimatter-UNIFORM-0.1.log')
upsert_antimatter_025 = open_csv(upsert_base_path + 'upsert-antimatter-UNIFORM-0.25.log')
...
upsert_validation_norepair_005 = open_csv(upsert_base_path + 'upsert-validation-norepair-UNIFORM-0.05.log')
upsert_validation_norepair_01 = open_csv(upsert_base_path + 'upsert-validation-norepair-UNIFORM-0.1.log')
upsert_validation_norepair_025 = open_csv(upsert_base_path + 'upsert-validation-norepair-UNIFORM-0.25.log')
...
upsert_validation_005 = open_csv(upsert_base_path + 'upsert-validation-UNIFORM-0.05.log')
upsert_validation_01 = open_csv(upsert_base_path + 'upsert-validation-UNIFORM-0.1.log')
upsert_validation_025 = open_csv(upsert_base_path + 'upsert-validation-UNIFORM-0.25.log')
...
upsert_inplace_005 = open_csv(upsert_base_path + 'upsert-inplace-UNIFORM-0.05.log')
upsert_inplace_01 = open_csv(upsert_base_path + 'upsert-inplace-UNIFORM-0.1.log')
upsert_inplace_025 = open_csv(upsert_base_path + 'upsert-inplace-UNIFORM-0.25.log')
upsert_inplace_05 = open_csv(upsert_base_path + 'upsert-inplace-UNIFORM-0.5.log')
...
plot_basic([ PlotOption(upsert_antimatters[i], 'eager', marker=markers[0], linestyle=antimatter_linestyle, color=antimatter_color),
            ...
            result_base_path + 'upsert-secondary-uniform-' + str(updates[i]) + '.pdf', "Ingestion Performance with Update Ratio " + str(updates[i]), framealpha=0.5, figsize = (3.75, 2.5))
