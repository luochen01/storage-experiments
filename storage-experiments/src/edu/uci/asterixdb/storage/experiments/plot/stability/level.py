...
def process(dist):
    ...
    plot_writes([
        ...
        ], result_base_path + 'write-level-' + dist + '.pdf', ylimit=15)
    ...
    plot_writes([
        ...
        get_fair_scheduler(fair_time, fair_data),
        get_greedy_scheduler(greedy_time, greedy_data),
        ], result_base_path + 'write-level-open-' + dist + '.pdf', post=post_write)
    ...
    def post():
        plt.legend(loc=4, ncol=1, bbox_to_anchor=(0.7, 0.2))
    ...
    plot_latencies([
                    ...
                    result_base_path + 'write-level-write-latency-' + dist + '.pdf', ylimit=4000 * 1000,
                    post=post)
