...
def plot_tune_ycsb():
    ...
    lines = plot_axis(axs[0], '(a) Tuned Write Memory', time_values, limit_4G, options, xlabel=xlabel_time, ylabel=ylabel_write_memory, use_raw_value=True)  
    ...
    for i in range(0, len(names)):
        ...
        options.append(get_option(xvalues, yvalues, names[i]))
    lines = plot_axis(axs[1], '(b) Tuned I/O Cost', time_values, limit_cost, options, xlabel=xlabel_time, ylabel=ylabel_op_io, use_raw_value=True)  
    ...
    for i in range(0, len(names)):
        ...
        yvalues = np.array(sheet.col_values(i * 3 + 1, start_index, start_index + lens[i])) / 1024
        options.append(get_option(xvalues, yvalues, names[i]))
    lines = plot_axis(axs[2], '(a) Tuned Write Memory', time_values, limit_20G, options, xlabel=xlabel_time, ylabel=ylabel_write_memory, use_raw_value=True) 
    ...
    for i in range(0, len(names)):
        ...
        yvalues = np.array(sheet.col_values(i * 3 + 2, start_index + 1, start_index + lens[i]))
        options.append(get_option(xvalues, yvalues, names[i]))
    lines = plot_axis(axs[3], '(b) Tuned I/O Cost', time_values, limit_cost, options, xlabel=xlabel_time, ylabel=ylabel_op_io, use_raw_value=True)  
