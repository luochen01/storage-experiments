...
plot_basic(options[0], result_base_path+'upsert-secondary-update-0.pdf', '', figsize=figsize)
plot_basic(options[1], result_base_path+'upsert-secondary-update-uniform-50.pdf', '', figsize=figsize)
plot_basic(options[2], result_base_path+'upsert-secondary-update-zipf-50.pdf', '', figsize = figsize)
