...
public class Order implements TpchEntity {
    ...
    public String toLine() {
        return String.format(ENGLISH, "%d|%d|%s|%s|%s|%s|%s|%d|%s|", orderKey, customerKey, orderStatus,
                formatMoney(totalPrice), formatDate(orderDate), orderPriority, clerk, shipPriority, comment);
    }
}
