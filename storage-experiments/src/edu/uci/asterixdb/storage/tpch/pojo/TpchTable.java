...
public abstract class TpchTable<E extends TpchEntity> {
    ...
    public static final TpchTable<Partsupp> PART_SUPPLIER =
            new TpchTable<Partsupp>("partsupp", PartSupplierColumn.values()) {
                @Override
                public Iterable<Partsupp> createGenerator(double scaleFactor, int part, int partCount) {
                    return new PartsuppGenerator(scaleFactor, part, partCount);
                }
            };
