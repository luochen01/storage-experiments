...
public class NationGenerator implements TpchGenerator<Nation> {
    ...
    private static class NationGeneratorIterator extends AbstractIterator<Nation> {
        ...
        protected Nation computeNext() {
            ...
            Nation nation = new Nation(index, index, nations.getValue(index), nations.getWeight(index),
    ...
    public long cardinality() {
        return distributions.getNations().size();
    }
