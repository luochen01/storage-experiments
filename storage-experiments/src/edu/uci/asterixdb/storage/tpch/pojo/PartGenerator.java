...
public class PartGenerator implements TpchGenerator<Part> {
    ...
    public Iterator<Part> iterator() {
        return new PartGeneratorIterator(distributions, textPool,
    ...
    private static class PartGeneratorIterator extends AbstractIterator<Part> {
        ...
        private Part makePart(long partKey) {
            ...
            return new Part(partKey, partKey, name, String.format(ENGLISH, "Manufacturer#%d", manufacturer),
                    String.format(ENGLISH, "Brand#%d", brand), typeRandom.nextValue(), sizeRandom.nextValue(),
                    containerRandom.nextValue(), calculatePartPrice(partKey), commentRandom.nextValue());
        }
    }
