...
public class CustomerGenerator implements TpchGenerator<Customer> {
    ...
    private static class CustomerGeneratorIterator extends AbstractIterator<Customer> {
        ...
        private Customer makeCustomer(long customerKey) {
            ...
            return new Customer(customerKey, customerKey, String.format(ENGLISH, "Customer#%09d", customerKey),
                    addressRandom.nextValue(), nationKey, phoneRandom.nextValue(nationKey),
                    accountBalanceRandom.nextValue(), marketSegmentRandom.nextValue(), commentRandom.nextValue());
        }
    }
}
