...
import static edu.uci.asterixdb.storage.tpch.pojo.LineItemGenerator.*;
import static edu.uci.asterixdb.storage.tpch.pojo.PartGenerator.*;
...
public class OrderGenerator implements TpchGenerator<Order> {
    ...
    public Iterator<Order> iterator() {
        return new OrderGeneratorIterator(distributions, textPool, scaleFactor,
    ...
    private static class OrderGeneratorIterator extends com.google.common.collect.AbstractIterator<Order> {
        ...
        private Order makeOrder(long index) {
            ...
            return new Order(index, orderKey, customerKey, orderStatus, totalPrice, toEpochDate(orderDate),
                    orderPriorityRandom.nextValue(), String.format(ENGLISH, "Clerk#%09d", clerkRandom.nextValue()), 0,
