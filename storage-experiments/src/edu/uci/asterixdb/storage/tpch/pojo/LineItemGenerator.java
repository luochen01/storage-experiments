...
import static edu.uci.asterixdb.storage.tpch.pojo.OrderGenerator.*;
import static edu.uci.asterixdb.storage.tpch.pojo.PartsuppGenerator.*;
...
public class LineItemGenerator implements TpchGenerator<LineItem> {
    ...
    private static class LineItemGeneratorIterator extends com.google.common.collect.AbstractIterator<LineItem> {
        ...
        private LineItem makeLineitem(long orderIndex) {
            ...
            return new LineItem(orderIndex, orderKey, partKey, supplierKey, lineNumber + 1, quantity, extendedPrice,
                    discount, tax, returnedFlag, status, toEpochDate(shipDate), toEpochDate(commitDate),
