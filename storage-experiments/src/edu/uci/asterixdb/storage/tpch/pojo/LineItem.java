...
public class LineItem implements TpchEntity {
    ...
    public String toLine() {
        return String.format(ENGLISH, "%d|%d|%d|%d|%d|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|", orderKey, partKey,
                supplierKey, lineNumber, quantity, formatMoney(extendedPrice), formatMoney(discount), formatMoney(tax),
                returnFlag, status, formatDate(shipDate), formatDate(commitDate), formatDate(receiptDate),
