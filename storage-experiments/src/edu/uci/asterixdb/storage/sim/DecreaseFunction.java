...
public class DecreaseFunction implements DifferentiableUnivariateFunction, Serializable {
    ...
    public DecreaseFunction(double a, double b) {
        super();
        this.a = a;
        this.b = b;
    }
    ...
    public static class Parametric implements ParametricUnivariateFunction {
        ...
        public double[] gradient(double x, double... parameters) {
            ...
            gradient[0] = Math.pow(Math.E, -parameters[1] * x);
